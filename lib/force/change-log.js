...
class ChangeLog {
  ...
  _write(sync) {
    return sync ?
      fs.writeJsonSync(this.file,this.log) : fs.writeJson(this.file,this.log);
  }
}
...
//
//     // TODO Fix this hack
//     if(async) return fs.writeJson(this.file,this.log);
//     else return fs.writeJsonSync(this.file,this.log);
//   }
//
//   /**
